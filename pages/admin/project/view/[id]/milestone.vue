       ...
       <div class="col-span-12 border border-panel-text-light/20 rounded-xl p-2">
           <div class="navs">
            <ul class="flex items-center">
              ...
              <li><nuxt-link class="p-3 rounded inline-block text-panel-text-light bg-panel-sub-text/100 duration-300 ease-linear transition-all hover:bg-panel-sub-text" :to="`/admin/project/view/${$route.params.id}/milestone`">Milestone/Budget</nuxt-link></li>
