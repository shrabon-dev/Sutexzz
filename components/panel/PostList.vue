        ...
        <div class="flex flex-wrap justify-between">
          <div class="w-full ">
              <div class="title flex items-center justify-between  bg-panel-text-light/5 rounded-lg p-2 mb-2">
                <div class="tl_lft">
                  <h6 class="font-jost text-lg text-panel-text-light">Post List</h6>
                  <p class="font-jost text-sm text-panel-sub-text">All post lists</p>
                </div>
                <div class="actn">
                ...
                <table class="w-full text-left">
                  <thead class="border-b pb-2 border-panel-sub-dark">
                    <tr>
                      ...
                      <th class="text-base font-medium font-jost text-panel-text-light">Title</th>
                      <th class="text-base font-medium font-jost text-panel-text-light">Cover</th>
                  ...
                  <tbody>
                    <tr class="border-b border-panel-text-light/5">
                      ...
                      <td class="text-base text-panel-text-light py-2 px-4"> Lorem ipsum dolor sit amet. </td>
                      <td class="text-base text-panel-text-light py-2 px-4"> <img class="w-10 h-10" src="/assets/image/pl.jpg" alt="pl.jpg" /> </td>
