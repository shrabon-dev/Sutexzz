<template>
      <div class="card border border-panel-sub-text/50 rounded-lg p-4 shadow-lg">
          <div class="title flex items-center justify-between  bg-panel-text-light/5 rounded-lg p-2 mb-2">
            <div class="tl_lft">
              <h6 class="font-jost text-lg text-panel-text-light">Account Plan</h6>
              <p class="font-jost text-sm text-panel-sub-text">Your current plan <span class="text-blue-200 bg-blue-200/20 px-2 rounded">Free Version</span></p>
            </div>
            <div class="actn">
          ...
          <div class="datas pt-5">
             <div class="plan flex items-center justify-between w-full">
               <span class="w-24 h-24 rounded-full flex justify-center shadow-xl items-center text-base  font-poppin bg-blue-600/10 text-blue-300"> Standard </span>
               <span class="w-40 h-40 bg-blue-600/10 text-blue-300 shadow-xl rounded-full flex justify-center items-center text-4xl font-poppin font-medium border border-blue-300/20"> Free </span>
