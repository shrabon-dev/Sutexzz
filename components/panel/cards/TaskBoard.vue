                      ...
                      <ul>
                        <li class="sm:flex justify-content-between items-start bg-panel-sub-dark rounded-lg p-3 mb-2">
                          ...
                          <div class="gp sm:w-3/5">
                            ...
                            <div class="files">
                              <span class="border cursor-pointer m-1 border-panel-text-light/20 bg-[#57685c] rounded-full px-4 py-1 inline-flex items-center gap-1 text-panel-text-light"><Icon icon="ic:outline-file-download"/> newtask.pdf</span>
                              <span class="border cursor-pointer m-1 border-panel-text-light/20 bg-[#57685c] rounded-full px-4 py-1 inline-flex items-center gap-1 text-panel-text-light"><Icon icon="ic:outline-file-download"/> newtask.pdf</span>
                              <span class="border cursor-pointer m-1 border-panel-text-light/20 bg-[#57685c] rounded-full px-4 py-1 inline-flex items-center gap-1 text-panel-text-light"><Icon icon="ic:outline-file-download"/> newtask.pdf</span>
                            </div>
                          </div>
                          <span class="action sm:w-2/6 pl-10">
                            <div class="end_dte">
                              <p class="border-l-2 border-panel-sub-text text-orange-400 p-1  rounded text-base font-medium font-jost text-start pl-2 ">End Date 
                                <span class="block text-panel-text-light font-normal pt-1">3/02/2026</span>
                              </p>
                            </div>
                ...
                <div class="w-full sm:w-2/5 lg:w-full xl:w-2/5 sm:pl-2 md:pl-5">
                  ...
                  <div class="task_list border border-panel-text-light/20 mt-5 p-1 md:p-5 rounded-xl">
                    <ul class="text-end max-h-92 overflow-auto">
                      <li class="text-xs md:text-base mb-2 cursor-pointer hover:bg-orange-500 transition-all ease-linear duration-300 font-jost bg-panel-sub-dark pl-10 rounded-full text-panel-text-light font-medium text-end block">Bug Fix<span class="ml-10 rounded-full px-5 py-2 inline-block bg-panel-dark shadow-lg border-l-2 border-orange-500">Task 1</span></li>
                      <li class="text-xs md:text-base mb-2 cursor-pointer hover:bg-orange-500 transition-all ease-linear duration-300 font-jost bg-panel-sub-dark pl-10 rounded-full text-panel-text-light font-medium text-end block">Bug Fix<span class="ml-10 rounded-full px-5 py-2 inline-block bg-panel-dark shadow-lg border-l-2 border-orange-500">Task 1</span></li>
                      <li class="text-xs md:text-base mb-2 cursor-pointer hover:bg-orange-500 transition-all ease-linear duration-300 font-jost bg-panel-sub-dark pl-10 rounded-full text-panel-text-light font-medium text-end block">Bug Fix<span class="ml-10 rounded-full px-5 py-2 inline-block bg-panel-dark shadow-lg border-l-2 border-orange-500">Task 1</span></li>
                      <li class="text-xs md:text-base mb-2 cursor-pointer hover:bg-orange-500 transition-all ease-linear duration-300 font-jost bg-panel-sub-dark pl-10 rounded-full text-panel-text-light font-medium text-end block">Bug Fix<span class="ml-10 rounded-full px-5 py-2 inline-block bg-panel-dark shadow-lg border-l-2 border-orange-500">Task 1</span></li>
                      <li class="text-xs md:text-base mb-2 cursor-pointer hover:bg-orange-500 transition-all ease-linear duration-300 font-jost bg-panel-sub-dark pl-10 rounded-full text-panel-text-light font-medium text-end block">Bug Fix<span class="ml-10 rounded-full px-5 py-2 inline-block bg-panel-dark shadow-lg border-l-2 border-orange-500">Task 1</span></li>
