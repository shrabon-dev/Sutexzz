    ...
    <aside class="bg-panel-dark p-5 lg:p-5 text-white border-panel-sub-dark rounded-lg h-screen fixed w-fit">
        ...
        <ul class="space-y-5">
            ...
            <li class="haveChild group"><nuxt-link to="/admin" class="font-jost text-sm xl:text-lg text-white font-light flex gap-4 items-center duration-300 ease-in-out hover:text-panel-sub-text border-r-4 border-transparent hover:border-panel-sub-text"> <Icon icon="humbleicons:pie-chart" class="rounded-sm bg-panel-sub-dark flex justify-center  items-center text-xl w-8  h-8 p-1" /> Project Management 
                ...
                <div class="hvr_prnt max-h-0 group-hover:max-h-[150px] overflow-hidden duration-1000 ease-in-out">
            ...
            <li class=""><nuxt-link to="/admin/user" class="font-jost  text-sm xl:text-lg text-white font-light flex gap-4 items-center duration-300 ease-in-out hover:text-panel-sub-text border-r-4 border-transparent hover:border-panel-sub-text"> <Icon class="rounded-sm bg-panel-sub-dark flex justify-center  items-center text-xl w-8  h-8 p-1" icon="mdi:user-settings" /> Profile</nuxt-link></li>
            <li class=""><nuxt-link to="/admin/setting" class="font-jost  text-sm xl:text-lg text-white font-light flex gap-4 items-center duration-300 ease-in-out hover:text-panel-sub-text border-r-4 border-transparent hover:border-panel-sub-text"> <Icon class="rounded-sm bg-panel-sub-dark flex justify-center  items-center text-xl w-8  h-8 p-1" icon="mdi:bell-settings" /> Settings</nuxt-link></li>
            <li class=""><nuxt-link to="/admin/billing" class="font-jost  text-sm xl:text-lg text-white font-light flex gap-4 items-center duration-300 ease-in-out hover:text-panel-sub-text border-r-4 border-transparent hover:border-panel-sub-text"> <Icon class="rounded-sm bg-panel-sub-dark flex justify-center  items-center text-xl w-8  h-8 p-1" icon="mdi:money" /> Billings</nuxt-link></li>
            <li class=""><nuxt-link to="/admin/user-list" class="font-jost  text-sm xl:text-lg text-white font-light flex gap-4 items-center duration-300 ease-in-out hover:text-panel-sub-text border-r-4 border-transparent hover:border-panel-sub-text"> <Icon class="rounded-sm bg-panel-sub-dark flex justify-center  items-center text-xl w-8  h-8 p-1" icon="mdi:format-list-bulleted" /> Users</nuxt-link></li>
            <li class=""><nuxt-link   @click="auth.logout()" class="font-jost  text-sm xl:text-lg text-white font-light cursor-pointer flex gap-4 items-center duration-300 ease-in-out hover:text-panel-sub-text border-r-4 border-transparent hover:border-panel-sub-text"> <Icon class="rounded-sm bg-panel-sub-dark flex justify-center  items-center text-xl w-8  h-8 p-1" icon="mdi:logout" /> Logout</nuxt-link></li>
        </ul>
    </aside>
</template>
<script setup>
