    ...
    <section id="cus_sect" class="bg-white/5 py-20">
      <div class="container mx-auto px-4">
        <div class="title text-center pb-16">
            <span class="bg-btn font-inter text-white text-base font-normal px-4 py-2 rounded-4xl inline-block mb-3">Client</span>
            <h4 class="text-white font-inter font-bold text-4xl">Our Customer</h4>
        </div>
